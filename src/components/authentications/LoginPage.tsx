      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-3xl shadow-2xl p-8 border border-gray-100 dark:border-gray-700 animate-slide-up">
          ...
          <div className="space-y-3 mb-6">
            ...
            <button className="w-full flex items-center justify-center gap-3 p-3.5 border-2 border-gray-200 dark:border-gray-700 rounded-xl font-semibold text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700 transition-all">
